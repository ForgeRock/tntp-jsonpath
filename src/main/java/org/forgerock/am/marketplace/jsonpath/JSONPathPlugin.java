...
public class JSONPathPlugin extends AbstractNodeAmPlugin {
	...
	static private String currentVersion = "0.0.20";
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(JSONPathPlugin.currentVersion, 
				Collections.singletonList(JSONPath.class));
	}
	...
	public void upgrade(String fromVersion) throws PluginException {
		...
		try {
			pluginTools.upgradeAuthNode(JSONPath.class);
		} catch (Exception e) {
	...
	public String getPluginVersion() {
		return JSONPathPlugin.currentVersion;
	}
}
